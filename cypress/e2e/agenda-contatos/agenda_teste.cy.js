...
describe('Testes de Crud Contatos', () => {
    ...
    it('deve incluir um novo contato', () => {
        cy.get('[type="text"]').type('Jean eugenio')
        cy.get('[type="email"]').type('Jeaneugenioteste@gmail.com')
        cy.get('[type="tel"]').type('21 12345678')
    ...
    it('deve alterar o primeiro contato selecionado', () => {
        ...
        cy.get('[type="text"]').type('Gabriel barbosa')

        cy.get('[type="email"]').clear()
        cy.get('[type="email"]').type('gabrielbarbosa@Gmail.com')

        cy.get('[type="tel"]').clear()
        cy.get('[type="tel"]').type('21 19202124')
